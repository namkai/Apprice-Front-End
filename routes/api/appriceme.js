...
router.route('/').post(function(req, res, next){
    ...
    knex('stores_products').whereIn('product_id', selectedProductsIds).andWhere(function(){
        ...
        .then(function(storesProductsData){
            ...
            returnData.forEach(function(currentStoreProduct){
...
//         {"products": { "id": 8, "upc": "037000138815", "plu": null, "name": "Tide Original Scent Liquid (75 oz.)", "brand_name": "Tide", "brand_type": "Original Scent Liquid", "size": "75 oz.", "product_image_url": "https://i5.walmartimages.com/asr/3915ec1e-7968-456a-ad1d-e0897671e7c6_1.a9dac59d32cd4344d473213c761ae62b.jpeg"}},
...
//         {"products": { "id": 47, "upc": null, "plu": "94050", "name": "Cantaloupe (large) [organic]", "brand_name": null, "brand_type": null, "size": "large", "product_image_url": "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQzAZEG33Tn3FOuGvmwlzg6IUxrUpdgOX26xMrI5gAZU3SQ1MmAWQ"}},
...
//                         {         "id": 7,         "name": "Trader Joe's",         "address": "555 9th St, San Francisco, CA 94103",         "phone_number": "(415) 863-1292",         "store_url": "http://www.traderjoes.com/",         "store_image_url": "http://www.traderjoes.com/images/announcement/778-Davie-Store.jpg",         "latitude": 37.7707200,         "longitude": -122.4075760      } ]}
// }
