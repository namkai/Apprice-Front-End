    ...
    .then(function () {
      return Promise.all([
          ...
          knex('products').insert({
            ...
            brand_type: "Classic Potato Chips",
            size: "15.75 oz.",
            product_image_url: "http://target.scene7.com/is/image/Target/13335441?wid=450&hei=450&fmt=pjpeg",
            created_at: new Date('2016-11-14 20:26:16 UTC'),
            updated_at: new Date('2016-11-14 20:26:16 UTC')
          }).returning('id'),
          ...
          knex('products').insert({
            ...
            brand_type: "Classic",
            size: "2 L",
            product_image_url: "http://target.scene7.com/is/image/Target/12958783?wid=450&hei=450&fmt=pjpeg",
            created_at: new Date('2016-11-14 20:26:16 UTC'),
            updated_at: new Date('2016-11-14 20:26:16 UTC')
          }).returning('id'),
          ...
          knex('products').insert({
            ...
            size: "11.5 oz.",
            product_image_url: "http://target.scene7.com/is/image/Target/16503532?wid=450&hei=450&fmt=pjpeg",
          ...
          knex('products').insert({
            ...
            brand_type: "Real Mayonnaise",
            size: "20 oz.",
            product_image_url: "http://target.scene7.com/is/image/Target/16503523?wid=450&hei=450&fmt=pjpeg",
            created_at: new Date('2016-11-15 20:26:16 UTC'),
            updated_at: new Date('2016-11-15 20:26:16 UTC')
          }).returning('id'),
          ...
          knex('products').insert({
            ...
            upc: "492610601058",
            plu: null,
            name: "C&H Pure Cane Powdered Sugar (2 lb.)",
            brand_name: "C&H",
            brand_type: "Pure Cane Powdered White Sugar",
            size: "2 lb.",
            product_image_url: "http://target.scene7.com/is/image/Target/13379073?wid=450&hei=450&fmt=pjpeg",
            created_at: new Date('2016-11-15 20:26:16 UTC'),
            updated_at: new Date('2016-11-15 20:26:16 UTC')
          }).returning('id'),
          ...
          knex('products').insert({
            ...
            size: "4 lb.",
            product_image_url: "http://target.scene7.com/is/image/Target/13379070?wid=450&hei=450&fmt=pjpeg",
            created_at: new Date('2016-11-15 20:26:16 UTC'),
            updated_at: new Date('2016-11-15 20:26:16 UTC')
          }).returning('id'),
          ...
          knex('products').insert({
            ...
            upc: "492610200466",
            plu: null,
            name: "Lawry's Seasoned Salt (8 oz.)",
            brand_name: "Lawry's",
            brand_type: "Seasoned Salt",
            size: "8 oz.",
            product_image_url: "http://target.scene7.com/is/image/Target/13406684?wid=450&hei=450&fmt=pjpeg",
            created_at: new Date('2016-11-15 20:26:16 UTC'),
            updated_at: new Date('2016-11-15 20:26:16 UTC')
          }).returning('id'),
          ...
          knex('products').insert({
            ...
            upc: "492610202217",
            plu: null,
            name: "McCormick Pure Vanilla Extract (1 oz.)",
            brand_name: "McCormick",
            brand_type: "Pure Vanilla Extract",
            size: "1 oz.",
            product_image_url: "http://target.scene7.com/is/image/Target/13353205?wid=450&hei=450&fmt=pjpeg",
            created_at: new Date('2016-11-15 20:26:16 UTC'),
            updated_at: new Date('2016-11-15 20:26:16 UTC')
          }).returning('id'),
          ...
          knex('products').insert({
            ...
            brand_type: "Pure Vanilla Extract",
            size: "2 oz.",
            product_image_url: "http://target.scene7.com/is/image/Target/13353225?wid=450&hei=450&fmt=pjpeg",
            created_at: new Date('2016-11-15 20:26:16 UTC'),
            updated_at: new Date('2016-11-15 20:26:16 UTC')
          }).returning('id'),
          ...
          knex('products').insert({
            ...
            size: "2 oz.",
            product_image_url: "http://target.scene7.com/is/image/Target/13170820?wid=450&hei=450&fmt=pjpeg",
            created_at: new Date('2016-11-15 20:26:16 UTC'),
            updated_at: new Date('2016-11-15 20:26:16 UTC')
          }).returning('id'),
          ...
          knex('products').insert({
            ...
            size: "1 lb.",
            product_image_url: "http://target.scene7.com/is/image/Target/14729228?wid=450&hei=450&fmt=pjpeg",
            created_at: new Date('2016-11-14 20:26:16 UTC'),
            updated_at: new Date('2016-11-14 20:26:16 UTC')
          }).returning('id'),
          ...
          knex('products').insert({
            ...
            size: "1 lb.",
            product_image_url: "http://target.scene7.com/is/image/Target/13424065?wid=450&hei=450&fmt=pjpeg",
            created_at: new Date('2016-11-14 20:26:16 UTC'),
            updated_at: new Date('2016-11-14 20:26:16 UTC')
          }).returning('id'),
          ...
          knex('products').insert({
            ...
            size: "8 oz.",
            product_image_url: "http://target.scene7.com/is/image/Target/21506483?wid=450&hei=450&fmt=pjpeg",
            created_at: new Date('2016-11-14 20:26:16 UTC'),
            updated_at: new Date('2016-11-14 20:26:16 UTC')
          }).returning('id'),
          ...
          knex('products').insert({
            ...
            size: "12 oz.",
            product_image_url: "http://target.scene7.com/is/image/Target/47112516?wid=450&hei=450&fmt=pjpeg",
            created_at: new Date('2016-11-16 20:26:16 UTC'),
            updated_at: new Date('2016-11-16 20:26:16 UTC')
          }).returning('id'),
          ...
          knex('products').insert({
            ...
            brand_name: "Ronzoni",
            brand_type: "Healthy Harvest Thin Spaghetti Ancient Grains",
            size: "12 oz.",
          ...
          knex('products').insert({
            ...
            brand_type: "Organic Red Heirloom Pasta Sauce",
            size: "26 oz.",
          ...
          knex('products').insert({
            ...
            brand_name: "Dave's Gourmet",
            brand_type: "Butternut Squash Pasta Sauce",
            size: "25.5 oz.",
          ...
          knex('products').insert({
            ...
            brand_name: "Rao's",
            brand_type: "Homemade Marinara Sauce",
            size: "24 oz.",
          ...
          knex('products').insert({
            ...
            brand_name: "Barilla",
            brand_type: "Traditional Pasta Sauce",
            size: "24 oz.",
          ...
          knex('products').insert({
            ...
            brand_name: "Horizon",
            brand_type: "Organic Shreds Monterey Jack Finely Shredded Cheese",
            size: "6 oz.",
          ...
          knex('products').insert({
            ...
            brand_name: "Horizon",
            brand_type: "Organic Shreds Mexican Blend Finely Shredded Cheese",
            size: "6 oz.",
          ...
          knex('products').insert({
            ...
            brand_name: "Sargento",
            brand_type: "Reduced Fat 4 Cheese Mexican Shredded Cheese",
            size: "8 oz.",
          ...
          knex('products').insert({
            ...
            brand_name: "Kraft",
            brand_type: "Big Slice Pepper Jack Cheese Slices",
            size: "8 oz.",
          ...
          knex('products').insert({
            ...
            brand_name: "Kraft",
            brand_type: "Finely Shredded Mild Cheddar Cheese Made with 2% Reduced Fat Milk and Added Calcium",
            size: "7 oz.",
          ...
          knex('products').insert({
            ...
            brand_name: "Kraft",
            brand_type: "Finely Shredded Sharp Cheddar Cheese Made with 2% Reduced Fat Milk and Added Calcium",
            size: "7 oz.",
          ...
          knex('products').insert({
            ...
            brand_type: "Alfresco Large Eggs",
            size: "12 Ct.",
          ...
          knex('products').insert({
            ...
            brand_type: "Cinnamon Toast Crunch Cereal",
            size: "17 oz.",
          ...
          knex('products').insert({
            ...
            brand_name: "General Mills",
            brand_type: "Lucky Charms Original Cereal",
            size: "16 oz.",
          ...
          knex('products').insert({
            ...
            brand_type: "Organic Multigrain with Flax Seeds",
            size: "24 oz.",
          ...
          knex('products').insert({
            ...
            brand_name: "Rudi's",
            brand_type: "Organic 100% Whole Wheat Bread",
            size: "22 oz.",
          ...
          knex('products').insert({
            ...
            brand_name: "Wonder",
            brand_type: "Round Top White Sliced Bread",
            size: "20 oz.",
          ...
          knex('products').insert({
            ...
            upc: "051500050293",
            plu: null,
            name: "Laura Scudder Smooth Natural Peanut Butter (16 oz.)",
            brand_name: "Laura Scudder",
            brand_type: "Smooth Natural Peanut Butter",
            size: "16 oz.",
            product_image_url: "http://target.scene7.com/is/image/Target/13260259?wid=450&hei=450&fmt=pjpeg",
            created_at: new Date('2016-11-16 20:26:16 UTC'),
            updated_at: new Date('2016-11-16 20:26:16 UTC')
          }).returning('id'),
          ...
          knex('products').insert({
            ...
            upc: "051500050613",
            plu: null,
            name: "Laura Scudder Nutty Natural Peanut Butter (16 oz.)",
            brand_name: "Laura Scudder",
            brand_type: "Nutty Natural Peanut Butter",
            size: "16 oz.",
            product_image_url: "http://target.scene7.com/is/image/Target/13264193?wid=450&hei=450&fmt=pjpeg",
            created_at: new Date('2016-11-16 20:26:16 UTC'),
            updated_at: new Date('2016-11-16 20:26:16 UTC')
          }).returning('id'),
          ...
          knex('products').insert({
            ...
            brand_name: "Skippy",
            brand_type: "Chunky Peanut Butter",
            size: "16.3 oz.",
          ...
          knex('products').insert({
            ...
            brand_name: "Skippy",
            brand_type: "Creamy Peanut Butter Original",
            size: "16.3 oz.",
